...
class AddEventYoutub extends StatefulWidget {
  const AddEventYoutub({required Key key}) : super(key: key);

  @override
  State<AddEventYoutub> createState() => _AddEventYoutubState();
}

class _AddEventYoutubState extends State<AddEventYoutub> {
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            //   keyboardType: TextInputType.emailAddress,
                            //   decoration:
                            //       InputDecoration(labelText: "ادخل نوع الفعالية"),
                            //   validator: (value) {
                            //     if (value == null || value.isEmpty) {
                            //       return 'الرجاء  ادخال نوع الفعالية ';
                            //     }
                            //     return null;
                            //   },
                            // ),
