...
class AdminAddTools extends StatefulWidget {
  const AdminAddTools({super.key});

  @override
  State<AdminAddTools> createState() => _AdminAddToolsState();
}

class _AdminAddToolsState extends State<AdminAddTools> {
  final nameactorContllor = TextEditingController();
  final detalesContllor = TextEditingController();
  ...
  String collectionName = "AdminAddTools";
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'الرجاء   كتابة اسم المنتج ';
                          }
                          return null;
                        },
                      ),
                      TextFormField(
                        minLines: 1,
                        maxLines: 3,
                        controller: detalesContllor,
                        cursorColor: Colors.white,
                        textInputAction: TextInputAction.next,
                        keyboardType: TextInputType.emailAddress,
                        decoration: InputDecoration(
                            labelText: " الرجاء كتابة تفاصيل المنتج"),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'الرجاء  كتابة  تفاصيل المنتج   ';
                          }
                          return null;
                        },
                      ),
